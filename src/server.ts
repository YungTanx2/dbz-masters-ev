...
app.get('/api/analyze', async (req, res) => {
  ...
  try {
    ...
    if (boxPriceParam !== undefined && boxPriceParam !== '') {
      ...
      // DBS Masters boxes are named "{Set Name} Booster Box" (TCGCSV convention).
      ...
      // DBS Masters booster boxes appear as 'Normal' subType in TCGCSV prices
...
app.listen(PORT, () => {
  console.log(`\n══════════════════════════════════════════════════════════`);
  console.log(`  DBZ Masters EV Calculator running at http://localhost:${PORT}`);
  console.log(`══════════════════════════════════════════════════════════\n`);
});
